...
class PlotConfiguration {
    ...
    //Finds the best configuration and applies new plots until a zero collision configuration is found.
    //If zero collisions can't be found, it applies the configurations with the best score.
    ...
    //Empty root element, applies configuration and creates the map with plots based on the number of countries
    applyConfiguration(configs, element) {
        ...
        for (let config of configs) {
            ...
            //Checks if data from user is a HTML-element and appends it.
            ...
            //Applies rotation, position, tailsize and color
...
// Example usage:
const data = [{ x: 'sweden', y: '45%' }, { x: 'no', y: img3 }, { x: 'za', y: '76%' }, { x: 'algeria', y: '23%' } /*{ x: 'au', y: '11%' }, { x: 'colombia', y: '14%' }*/];
